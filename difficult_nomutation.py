...
def constant_size_environment_random():
    ...
    headertofile('constant_size_environment_randomD')
    ...
    print 'environment!'
    fobj = open('environmentD0.txt', 'a')
    fobj.write('environ_list: ' + str(environ_list))
    fobj.close()
        
    MetNet = MetabolicNetwork(met, reac, food, targets, 'difficult')

    
    fobj = open('MetNetD0.txt', 'a')
    ...
    while True:
        ...
        if a.time%ta == 0:
            ...
            print 'media_idades'
            fobj = open('media_idadesD0.txt', 'w')
...
def constant_size_environment_periodic_3():
    ...
    headertofile('constant_size_environment_periodic_3D')
