...
class MetabolicNetwork(nx.DiGraph):
    ...
    def __init__(self, metabolites, reactions, food, targets):
...
##            outm = rndm.randint(1,3)  #talvez fazer isso ser igual a um...
    ...
    def is_problem_solvable(self): #incluir outras configuracoes de comida
        ...
        #print self.node##producedbiomass()
